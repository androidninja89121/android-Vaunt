...
public class AboutVauntTermsFragment extends BaseFragment implements OnClickListener {
	...
	public static AboutVauntTermsFragment newInstance() {
		return new AboutVauntTermsFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater,
		...
		this.view = inflater.inflate(R.layout.fragment_about_vaunt_terms, container,
				false);
		return this.view;
	}
