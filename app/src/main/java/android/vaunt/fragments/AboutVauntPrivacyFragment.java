...
public class AboutVauntPrivacyFragment extends BaseFragment implements OnClickListener {
	...
	public static AboutVauntPrivacyFragment newInstance() {
		return new AboutVauntPrivacyFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater,
		...
		this.view = inflater.inflate(R.layout.fragment_about_vaunt_privacy, container,
				false);
		return this.view;
	}
