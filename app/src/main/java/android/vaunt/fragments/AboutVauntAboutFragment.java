...
public class AboutVauntAboutFragment extends BaseFragment implements OnClickListener {
	...
	public static AboutVauntAboutFragment newInstance() {
		return new AboutVauntAboutFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater,
		...
		this.view = inflater.inflate(R.layout.fragment_about_vaunt_about, container,
				false);
		return this.view;
	}
