...
public class BaseActivity extends SherlockFragmentActivity {
	...
	public BaseFragment rootFragment;
	...
	public void showFragment(int contentFrame, BaseFragment fragment,
		...
		case SLIDE_FROM_RIGHT:
			transaction.setCustomAnimations(R.anim.abc_slide_in_right,
					R.anim.abc_slide_out_left, R.anim.abc_slide_in_left,
...
//
//		int nStack = getSupportFragmentManager().getBackStackEntryCount();
//		if (nStack == 0 && addToBackStack == false)
